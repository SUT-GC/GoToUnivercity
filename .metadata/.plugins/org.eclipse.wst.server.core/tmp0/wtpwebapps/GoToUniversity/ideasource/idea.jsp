...
<body>
	<div class="content">
		...
		<div class="content_body">
			<div class="content_body_description">
				<h2>项目描述:</h2>
					...
					<p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  当你收到大学的录取通知书的时候，你是不是还不知道去学校应该拿什么？应该怎么去学校？你所要抵达的学校具体位置到底在哪里？你是不是想最好有一位学长给你介绍一些在学校生活的经验呢？</p>
			...
			<div class="content_body_content">
				<h2>Go To Univercity 就是立志于帮你解决上面所有的问题......</h2>		
				<div class="content_body_content_ui">
					<ul>
						<li><p>当你预估完分数（或者知道分数）的时候，输入所估的分数（或者知道分数），它就会根据去年的分数线给你列出可以录取你的高校，你可以根据地域和等级（211 OR 985）本科（一/二/三：为了适应先出分数线的同学）进行筛选。</p></li>
						<li><p>当你想了解某一个可能录取你的高校时，它会把这个学校的官网，贴吧，教务处，地址，街景，与行车路线展现到你的面前。最重要的是它会把该学校前五年的录取分数线形成走势图展现给你。当然还会列出以你的分数可以进入该学校的哪些专业(当然还是依据去年的录取分数线)。</p></li>
						...
						<li><p>如果你不喜欢平台交流，不相信论坛上的资料，它可以提供给你一些经过问卷调查出来的相对官方的物品需求。</p></li>
					</ul>
				</div>		
			</div>
		...
		<hr/>
		<div class="tail">
			<span class="tail_date">2015-11-16</span>          <span class="tail_writer">Write By GC</span>
		</div>
		<hr/>
	</div>
	</body>
